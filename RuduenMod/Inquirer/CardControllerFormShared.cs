...
namespace Workshopping.RuduenFanMods.Inquirer
{
	...
	public class CardControllerFormShared : RuduenCardController
	{
		// Token: 0x060028EC RID: 10476 RVA: 0x00023B10 File Offset: 0x00021D10
		public CardControllerFormShared(Card card, TurnTakerController turnTakerController) : base(card, turnTakerController)
		{
		}
		...
		private IEnumerator MoveOrDestroyResponse(PhaseChangeAction phaseChange)
		{
			...
			if (HeroTurnTaker.Trash.Cards.Count<Card>() >= 2)
            {
