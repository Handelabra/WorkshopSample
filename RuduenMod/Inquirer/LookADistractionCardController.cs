    ...
    public class LookADistractionCardController : InquirerDistortionSharedCardController
    {
        ...
        public override IEnumerator Play()
        {
            ...
            if (nextTo != null)
            {
                ...
                IEnumerator coroutine = this.GameController.SelectTargetsAndDealDamage(this.DecisionMaker, new DamageSource(this.GameController, nextTo), 4, DamageType.Melee, 1, false, 1, false, false, false, (Card c) => !c.IsHero && c != nextTo, null, null, null, null, false, null, null, false, null, this.GetCardSource(null));
