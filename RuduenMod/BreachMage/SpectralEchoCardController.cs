...
{
    public class SpectralEchoCardController : BreachMageSpellSharedCardController
    {
        public SpectralEchoCardController(Card card, TurnTakerController turnTakerController)
