...
namespace RuduenWorkshop.Spellforge
{
    public class WaveCardController : SpellforgeSharedEssenceCardController
    {
        ...
        protected override IEnumerator PerformModifiedAction()
        {
            ...
            IEnumerator coroutine = this.GameController.SelectTargetsAndDealDamage(this.DecisionMaker, new DamageSource(this.GameController, this.CharacterCard), 3, DamageType.Lightning, 5, false, 5, cardSource: this.GetCardSource());
